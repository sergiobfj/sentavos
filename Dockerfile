# Imagem da API do Sentavos. Render, Fly e Koyeb detectam este arquivo sozinhos e
# pulam o buildpack automático — que aqui erraria, porque o projeto usa uv e não
# um requirements.txt. É o que mantém o deploy portátil entre hosts.
...
# host escolhe a porta e injeta na variável (o Render usa 10000). Em colchetes, o
...
# conexão de dentro dele mesmo, e o roteador do host nunca chegaria.
